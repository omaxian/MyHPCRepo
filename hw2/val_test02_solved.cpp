...
//
  ...
  // Fix the unitialized problem by initializing all values to 0. 
  for ( i = 6; i < 10; i++ )
  {
    x[i] = 0;
  }
...
//  Print X.
//
// Memcheck throws errors on the value of x[2] when printing out because it
// depends on unitialized values. Fixed this by initializing those values to 0.   
  for ( i = 0; i < 10; i++ )
  {
    cout << "  " << i << "  " << x[i] << "\n";
  }
